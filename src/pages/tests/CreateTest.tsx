...
import { useCreateTest } from "@/lib/api/mutations/create-test-mutation";
...
export default function CreateTest() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (test.type === "mock") {
      ...
      delete testBody.startDate;
      delete testBody.startTime;
    }
    const apiBody = {
      ...testBody,
    ...
    try {
      const res = await createTestMutation.mutateAsync(apiBody);
      toast({
        title: "Test created successfully!",
        description: res?.message || "Test has been created.",
      });
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <RadioGroup
                    value={test.testType}
                    onValueChange={(val) =>
                      handleTestChange("testType", val as "free" | "paid")
                    }
                    className="flex flex-row gap-4"
                  >
                    <div className="flex items-center space-x-2">
